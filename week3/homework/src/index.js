...
app.get(`/${TODO_SLUG}/:id`,    readSingleToDo.bind(null, todo)); //  added
app.patch(`/${TODO_SLUG}/:id`,  patchToDo.bind(null, todo)); // added
app.delete(`/${TODO_SLUG}/`,    clearToDos.bind(null, todo)); // added
